      ...
      <div className="dark:bg-black bg-white dark:text-white text-black font-sans selection:bg-orange-500/30">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 max-w-4xl">
            The fastest way to ship AI-powered{" "}
          ...
          <div className="flex items-center gap-3 dark:text-neutral-100 text-neutral-900 text-sm font-medium">
            ...
            <Link
              ...
              className="dark:text-neutral-100 text-neutral-900 font-bold"
            >
              LayrdUI
            </Link>
          </div>
        ...
        {/* Outer layout container — no Magnetic here */}
        <div className="relative max-w-6xl mx-auto px-4 pb-24">
          {/* Magnetic wraps only the visual card, not the padding/layout wrapper */}
