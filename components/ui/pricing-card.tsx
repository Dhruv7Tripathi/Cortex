...
export function PricingCard({ tier, paymentFrequency }: PricingCardProps) {
  ...
  return (
    <Card
      className={cn(
        "relative flex flex-col  dark:bg-neutral-950 bg-neutral-50 text-foreground overflow-hidden transition-all duration-300",
        // Small screens
        ...
        isHighlighted && "border border-primary  scale-105",
